...
<head>
    ...
    <!-- Core CSS -->
    <link rel="stylesheet"
        href="{{ asset('backend/vendor/css/coredcac.css?id=7a74a9d0cfeabd283069bfaa3de33eaa') }}" />
    <link rel="stylesheet"
...
<body>
        ...
        <div class="layout-container">
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <div class="app-brand demo">
                    ...
                    <a href="{{ route('dashboard') }}"><img src="{{ asset('images/logo.png') }}" width="40%"
                            alt=""></a>
                                ...
                                <li class="nav-item dropdown">
                                    <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#"
                                        ...
                                        <img src="{{ asset('images/users/' . Auth::user()->userimage) }}"
                                            width="50px" height="50px" class="rounded-circle" alt="">
                                        {{ Auth::user()->name }}
                                    </a>
    ...
    <!-- Include Scripts -->
    <!-- BEGIN: Vendor JS-->
    <script src="{{ asset('backend//vendor/libs/jquery/jquery0bfa.js?id=c9eab148c98f81221c99ba6da84fdbe2') }}"></script>
