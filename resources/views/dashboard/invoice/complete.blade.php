...
@endsection
@section('dashboard_content') <div class="card card-table">
    <div class="card-body">

        <div class="row  justify-content-end  my-3">
            <div class="col-12">
                <h4 class="card-title  pl-3">Completed Orders</h4>
            </div>
                        ...
                        <td>
                            <h2 class="table-avatar">
                                ...
                                <a href="#" class="avatar avatar-sm mr-2">
                                    ...
                                    <img class="avatar-img rounded-circle"
                                        src="{{ asset('images/users/' . $service->user->userimage) }}" alt="User Image"
                                        width="50px">
                                </a>
